...
namespace app\platformapi\controller\v1\version;

use core\base\Controller;
use core\attribute\Permission;
use app\service\version\AppVersionService;
use app\platformapi\validate\v1\version\AppVersionValidate;
use think\Response;
...
class AppVersionController extends Controller
{
     ...
     * 版本列表
     */
    #[Permission('platform.version.list')]
    #[OA\Get(
        path: '/platformapi/version/list',
        summary: '获取版本列表',
        security: [['bearerAuth' => []]],
        tags: ['应用版本'],
        parameters: [
    ...
    #[Permission('platform.version.list')]
    #[OA\Get(
        path: '/platformapi/version/detail/{id}',
        summary: '获取版本详情',
        security: [['bearerAuth' => []]],
        tags: ['应用版本'],
        parameters: [
     ...
     * 创建版本
     */
    #[Permission('platform.version.create')]
    #[OA\Post(
        path: '/platformapi/version',
        summary: '创建版本',
        security: [['bearerAuth' => []]],
        tags: ['应用版本'],
     ...
     * 更新版本
     */
    #[Permission('platform.version.update')]
    #[OA\Put(
        path: '/platformapi/version/{id}',
        summary: '更新版本',
        security: [['bearerAuth' => []]],
        tags: ['应用版本'],
        parameters: [
     ...
     * 删除版本
     */
    #[Permission('platform.version.delete')]
    #[OA\Delete(
        path: '/platformapi/version/{id}',
        summary: '删除版本',
        security: [['bearerAuth' => []]],

...
namespace app\platformapi\controller\v1\region;

use core\base\Controller;
use core\attribute\Permission;
use app\service\region\RegionService;
use app\platformapi\validate\v1\region\RegionValidate;
use think\Response;
...
class RegionController extends Controller
{
     ...
     * 地区列表
     */
    #[Permission('platform.region.list')]
    #[OA\Get(
        path: '/platformapi/region/list',
        summary: '获取地区列表',
        security: [['bearerAuth' => []]],
        tags: ['区域管理'],
        parameters: [
    ...
    #[Permission('platform.region.list')]
    #[OA\Get(
        path: '/platformapi/region/detail/{id}',
        summary: '获取地区详情',
        security: [['bearerAuth' => []]],
        tags: ['区域管理'],
        parameters: [
     ...
     * 创建地区
     */
    #[Permission('platform.region.create')]
    #[OA\Post(
        path: '/platformapi/region',
        summary: '创建地区',
        security: [['bearerAuth' => []]],
        tags: ['区域管理'],
     ...
     * 更新地区
     */
    #[Permission('platform.region.update')]
    #[OA\Put(
        path: '/platformapi/region/{id}',
        summary: '更新地区',
        security: [['bearerAuth' => []]],
        tags: ['区域管理'],
        parameters: [
     ...
     * 删除地区
     */
    #[Permission('platform.region.delete')]
    #[OA\Delete(
        path: '/platformapi/region/{id}',
        summary: '删除地区',
        security: [['bearerAuth' => []]],

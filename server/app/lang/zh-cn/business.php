...
return [
    ...
    'system_dict_readonly'      => '系统字典为只读，不可修改',
    ...
    // 增值功能
    'addon_not_found'         => '增值功能不存在',
    'addon_already_purchased' => '您已购买该增值功能',
    'addon_trial_not_allowed' => '该功能不支持试用',
    'addon_trial_used'        => '该功能试用机会已使用',
    'addon_already_active'    => '您已开通该功能',
];

        ...
        <template #header>
            <div class="modal-head">
                <div class="modal-title">
                    ...
                    <span class="sub">{{ $t('common.columnConfigHint') }}</span>
                </div>
        ...
        <div class="col-cfg-list">
            ...
            >
                ...
                <label class="col-cfg-name">
                    ...
                    />
                    <span>{{ col.label }}</span>
                    <em v-if="col.required" class="tag-req">{{ $t('common.requiredCol') }}</em>
                </label>
                <span class="col-cfg-width">
                    {{ col.width ? `${col.width}px` : $t('common.autoWidth') }}
                </span>
                <div class="col-cfg-fix">
                    <button
                        class="fix-btn"
                        :class="{ on: col.fixed === 'left' }"
                        :title="$t('common.pinLeft')"

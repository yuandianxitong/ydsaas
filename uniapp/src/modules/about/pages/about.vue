<template>
  <d-page :safe-area="true">
    <view class="about-page">
      ...
      <!-- App Name -->
      <text class="about-name">元点SaaS</text>
      ...
      <text class="about-desc">
        元点SaaS 是一个基于 Vue3 + ThinkPHP8 的全栈管理系统框架，
        提供高效的前后端开发解决方案。
      </text>
      ...
      <view class="info-card">
        <u-cell-group>
          ...
          <u-cell title="许可协议" value="Apache-2.0" />
        </u-cell-group>
      </view>

      <!-- Copyright -->
      <view class="copyright">
        <text class="copyright-text">Copyright 2024 元点SaaS</text>
      </view>
    </view>
  </d-page>
</template>
